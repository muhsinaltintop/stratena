...
export const featuredStratenaWiseIssue = stratenaWiseIssues[0];

export const stratenaWiseIssueLookup = Object.fromEntries(
  stratenaWiseIssues.map((issue) => [issue.slug, issue]),
);
