        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {stratenaWiseIssues.map((issue) => (
            <Link
              ...
              aria-label={`Read ${issue.issue}: ${issue.title}`}
            >
              <article>
                ...
                <div className="p-8">
                  ...
                  <span className="mt-8 inline-flex items-center gap-2 text-sm font-bold uppercase tracking-[0.18em] text-primary transition-colors group-hover:text-navy">
                    Read Issue
